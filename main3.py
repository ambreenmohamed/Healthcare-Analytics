...
if st.sidebar.button("Predict Risk"):
    ...
    normal_values = [120, 25, 140, 200, 3, 80, 120, 80]
    
    ax.bar(categories, normal_values, color='#99CC99', label='Normal Range')
    ax.bar(categories, values, bottom=normal_values, color='#FF9999', label='Risk')
